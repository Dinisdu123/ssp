...
<head>
    ...
    <meta name="description" content="View and manage your shopping cart at Aurora Luxe.">
    <meta name="keywords" content="cart, shopping, Aurora Luxe">
    <title>Your Cart - Aurora Luxe</title>
...
@endauth
    ...
    <div class="container mx-auto px-4 py-12">
        <h1 class="text-2xl sm:text-3xl font-bold text-black tracking-wider uppercase mb-6">Your Cart</h1>
