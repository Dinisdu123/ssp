...
<head>
    ...
    <meta name="description" content="Order confirmation for your purchase at Aurora Luxe.">
    <meta name="keywords" content="order confirmation, Aurora Luxe">
    <title>Order Confirmation - Aurora Luxe</title>
...
<body class="bg-white text-black">
    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="border p-4 rounded-md bg-gray-50">
            ...
            <p><strong>Order Date:</strong> {{ $order->ordered_date->format('Y-m-d H:i:s') }}</p>
            ...
            @foreach ($order->items as $item)
                <div class="flex items-center space-x-4 mb-2">
                    <img src="{{ asset($item->product->image_url ?? $item->product->image) }}" alt="{{ e($item->product->name) }}" class="w-12 h-12 object-cover rounded">
                    <div>
